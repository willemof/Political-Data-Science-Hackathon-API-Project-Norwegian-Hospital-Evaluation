...
####
#### Ideas: 1. hypothesis testing if the change in a variable is significant 
#### 2. Break down the hospital statistics per inhabitant of hospital (population of municipalities)
#### DONE 3. Operating costs per 24-hour stay (driftskostnader/liggedager) 
#### 4. Make all the plots with plotly (for interactivity) 
#### 5. Ask about data envelopment app 
#### 6. Improve the code (make it shorter) 


# Creating a varuable of costs per 24-hours stay 
#super_merge <- super_merge %>% 
#  mutate(kost_per_dogn = value_driftskostnader/liggedager_oppholdsdogn)
#super_merge_regions <- super_merge_regions %>% 
#  mutate(kost_per_dogn = value_driftskostnader/oppholdsdogn)

## Presentation 
## R-markdown to Github 
## Upload to Inspera 
